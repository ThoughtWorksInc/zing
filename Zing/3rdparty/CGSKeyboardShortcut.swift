// 3rd party code in this file is MIT licensed.
// See https://github.com/avaidyam/CGSKeyboardShortcut
...
public final class CGSKeyboardShortcut: Hashable {
    ...
    public func hash(into hasher: inout Hasher) {
        hasher.combine(ObjectIdentifier(self).hashValue) // TODO[zing] - unclear if correct
